...
public class PlanetExplorer {
	...
	public static void main (String [] args) {
		...
		System.out.println("     by: Yashul Aggarwa");
		...
		double yourMassWeightOnEarth = 75;	// Kilograms
		...
		double massWeightOnEarth = yourMassWeightOnEarth / GRAVITATIONAL_ACCELERATION * GRAVITATIONAL_CONSTANT * 
				EARTH_MASS / Math.pow(EARTH_RADIUS, 2.0);
		System.out.println("   on Earth: " + mass.format(massWeightOnEarth) + " Kilograms");
